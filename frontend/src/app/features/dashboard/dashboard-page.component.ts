...
@Component({
  ...
  <div class="page">
    ...
    <div class="grid">
      ...
      <div class="col-6 card">
        ...
        <div *ngFor="let a of nextAppointments()" class="row">
          ...
          <div style="flex:1;">
            ...
            <div style="opacity:.75; font-size:12px;">{{ 'with' | t }}: <b>{{ a.withWhom }}</b></div>
          </div>
        </div>
      </div>
      ...
      <div class="col-6 card">
        <div style="display:flex; align-items:center; justify-content:space-between;">
          <div style="font-weight:800; font-size:16px;">{{ 'topTodos' | t }}</div>
        ...
        <div *ngFor="let t of topTodos()" class="row">
          ...
          <div style="flex:1;">
            ...
            <div style="opacity:.75; font-size:13px;">
              {{ 'owner' | t }}: <b>{{ t.owner || '—' }}</b>
              <span *ngIf="t.dueDate"> · {{ 'due' | t }}: {{ shortDate(t.dueDate) }}</span>
            </div>
          </div>
        </div>
      </div>
